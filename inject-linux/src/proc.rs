...
pub struct ProcRecord { pub pid: u32, pub comm: String, pub cmdline: String, pub status: String }

pub struct ProcInjector { output_dir: PathBuf }
impl ProcInjector { pub fn new(dir: PathBuf) -> Self { Self { output_dir: dir } } }
...
mod tests {
    ...
    fn test_proc_inject() {
        ...
        let records = vec![ProcRecord { pid: 1234, comm: "bash".into(), cmdline: "/bin/bash".into(), status: "S".into() }];
