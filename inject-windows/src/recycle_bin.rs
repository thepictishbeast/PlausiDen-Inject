...
pub struct RecycleBinInjector { output_dir: PathBuf }
impl RecycleBinInjector { pub fn new(dir: PathBuf) -> Self { Self { output_dir: dir } } }
...
mod tests {
    ...
    fn test_recycle_bin_inject() {
        ...
        let records = vec![RecycleBinRecord { original_path: "C:\\Users\\user\\Documents\\secret.docx".into(), file_size: 50000, deleted_at: Utc::now() }];
