...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum ThumbSize { Small, Medium, Large, ExtraLarge }

pub struct ThumbcacheInjector { output_dir: PathBuf }
impl ThumbcacheInjector { pub fn new(dir: PathBuf) -> Self { Self { output_dir: dir } } }
...
mod tests {
    ...
    fn test_thumbcache_inject() {
        ...
        let records = vec![ThumbcacheRecord {
            ...
            thumbnail_size: ThumbSize::Medium, image_hash: "abc123".into(), cached_at: Utc::now(),
        }];
